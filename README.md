...
education: "B.E CSE, Dhirajlal Gandhi College of Technology (2022 - 2026)"
cgpa: "7.69 / 10"
based_in: "Salem, Tamil Nadu, India"
currently:
  - "🔭 Building cloud-native, containerized applications"
  - "☁️ Sharpening AWS + Kubernetes + Jenkins skills"
  - "🌱 Leveling up Terraform & Ansible (IaC)"
  - "🎯 Targeting DevOps / Cloud Engineer roles in Bangalore"
experience: "Full Stack Development Intern @ Techforge, Salem"
awards:
  - "🥇 First Prize — Open Hack Day, Agni College of Technology, Chennai"
  - "🏆 Best Pitch Award — Malicious Code Detection, DGCT Salem"
certifications:
  - "Cloud Computing & DevOps Training — Besant Technologies"
...
- Jenkins pipeline integrated with GitHub webhooks
- Automated build, test, Docker image creation & deployment
- Configured rollback strategies for production safety

`Jenkins` `Docker` `Spring Boot` `Linux`
...
**with Kubernetes**
- Deployed with Pods, Deployments, ReplicaSets, Services
- Nginx reverse proxy & ingress routing
- Rolling updates, self-healing, monitored via Prometheus & Grafana

`Kubernetes` `Nginx` `Prometheus` `Grafana`
...
- FaceNet + OpenCV facial recognition engine
- Automated in-time / out-time tracking
- Dockerized with Flask + MySQL reporting

`Python` `Flask` `OpenCV` `Docker` `MySQL`

</td>
<td width="50%" valign="top">

### 🛒 Full Stack E-Commerce App
- REST APIs with auth, cart & admin modules
- Dockerized backend, Maven build automation
- Structured GitHub branching & deployment workflows

`React.js` `Spring Boot` `Maven` `Docker`
